...
- [ ] R1 test on 5 videos (mix of infield + talking_head)
...
- [ ] Verify talking_head: confirm topic sections match actual transitions, techniques discussed are accurate
...
### Automation
- [x] Validation layer: jsonschema + invariant checks in 06.video-type and 07.content
...
### R2: Full Pipeline Test
- [ ] Run stages 06-08 on 15 videos (12 infield + 3 talking head)
...
- **Testing phases:** R1 = 5 videos, R2 = 15 videos, Production = batches of 100.
