#!/usr/bin/env python3
"""Task 2: '4 Ways To Approach' Speaker Analysis"""
import json, os
from collections import Counter

BASE_DIR = "/home/jonaswsl/projects/daygame-coach/data/test/r2/04.diarize"
VIDEO_DIR = "4 Ways To Approach a Girl You Don't Know [With Examples] [LftMFDMrfAQ]"
...
print("=" * 120)
print("TASK 2: '4 Ways To Approach a Girl You Don't Know' - SPEAKER ANALYSIS")
print("=" * 120)
...
target_speakers = {"SPEAKER_01", "SPEAKER_02"}
target_indices = [i for i, seg in enumerate(segments) if seg["speaker"] in target_speakers]
print(f"\nFound {len(target_indices)} segments from SPEAKER_01 and SPEAKER_02")
print("\n" + "=" * 120)
...
for target_idx in target_indices:
    ...
    for i in range(cs, ce + 1):
        is_t = segments[i]["speaker"] in target_speakers
