...
export function JourneyLanding({ onSelectPath, onSelectLifeArea }: JourneyLandingProps) {
    ...
    <div className="space-y-10">
      ...
      <div className="text-center space-y-3 pt-4">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto text-sm">
          Start with your vision. We'll build a personalized goal tree with milestones, habits, and tracking — all customizable.
        </p>
      </div>
