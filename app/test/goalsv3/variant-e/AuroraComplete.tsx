...
export function AuroraComplete({
  path,
  selectedL1,
  selectedL2s,
  selectedL3s,
    ...
    <div className="relative space-y-8">
        ...
        {bgStars.map((s) => (
          <div
            ...
            style={{
              ...
              opacity: s.opacity,
              animation: `completeTwinkleAurora ${2 + s.delay}s ease-in-out ${s.delay}s infinite`,
            }}
          />
        ))}
        <style>{`
          @keyframes completeTwinkleAurora {
            0%, 100% { opacity: 0.05; }
            50% { opacity: 0.25; }
          }
        `}</style>
      ...
      <div className="relative text-center space-y-4 py-6">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(135deg, ${aurora.primary}18 0%, ${aurora.secondary}18 100%)`,
        ...
        <div className="flex items-center justify-center gap-6 pt-2">
          <div className="text-center">
            ...
            <div className="text-xs font-light" style={{ color: "rgba(255,255,255,0.35)" }}>Lights</div>
          </div>
          <div className="w-px h-8" style={{ background: `linear-gradient(180deg, transparent, ${aurora.primary}20, transparent)` }} />
          <div className="text-center">
            <div className="text-2xl font-extralight" style={{ color: aurora.secondary }}>{totalRibbons}</div>
            <div className="text-xs font-light" style={{ color: "rgba(255,255,255,0.35)" }}>Ribbons</div>
          </div>
          <div className="w-px h-8" style={{ background: `linear-gradient(180deg, transparent, ${aurora.primary}20, transparent)` }} />
          <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-4 pt-2 flex-wrap">
          ...
          <div
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-light"
            style={{
              border: `1px solid ${aurora.secondary}20`,
              background: `${aurora.secondary}08`,
      ...
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 30%, ${aurora.primary}12 0%, transparent 60%)`,
        ...
        <svg viewBox="0 0 100 45" className="w-full h-full relative" style={{ zIndex: 1 }}>
          <defs>
            <filter id="complete-aurora-glow">
          ...
          {/* Center bright point (L1) */}
          <circle cx={50} cy={18} r={2.5} fill={aurora.primary} fillOpacity={0.9} filter="url(#complete-aurora-glow)">
          ...
          {selectedL2s.map((l2, i) => {
            ...
            return (
              <g key={l2.id}>
                <line x1={50} y1={18} x2={x} y2={y} stroke={aurora.secondary} strokeOpacity={0.15} strokeWidth={0.12} />
                <circle cx={x} cy={y} r={1.2} fill={aurora.secondary} fillOpacity={0.65}>
                  <animate
      ...
      <div className="relative space-y-4 max-w-xl mx-auto">
        ...
        >
          <div
            ...
            style={{
              background: `linear-gradient(135deg, ${aurora.primary}08 0%, transparent 60%)`,
            }}
          />
          <div className="relative rounded-lg p-2" style={{ background: `${aurora.primary}12` }}>
            <div
            ...
            {l2Goals.map((g) => (
              ...
              >
                <div
                  ...
                  style={{ background: `${aurora.secondary}15` }}
                >
      ...
      >
        <div
          ...
          style={{ background: `${aurora.primary}10`, color: aurora.primary }}
        >
