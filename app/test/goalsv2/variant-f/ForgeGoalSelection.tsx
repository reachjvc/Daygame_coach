...
interface ForgeGoalSelectionProps {
  path: "one_person" | "abundance"
  onBack: () => void
  onConfirm: (selectedL1: GoalTemplate, selectedL2s: GoalTemplate[], selectedL3s: GoalTemplate[]) => void
}

export function ForgeGoalSelection({ path, onBack, onConfirm }: ForgeGoalSelectionProps) {
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected ? "shadow-md" : "border-border hover:border-border/80 hover:bg-muted/20"}
                `}
                style={isSelected ? {
              ...
              return (
                <div key={cat} className="rounded-lg border border-border/50 overflow-hidden">
                  <div className="flex items-center gap-3 p-3 bg-muted/20">
                    ...
                    >
                      {selectedInCat === goals.length ? "None" : "All"}
                    </button>
                  </div>
