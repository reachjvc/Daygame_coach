...
import { OrreryVisualization } from "./OrreryVisualization"
import type { LifeAreaConfig } from "@/src/goals/types"

interface OrreryLandingProps {
  onSelectPath: (path: "one_person" | "abundance") => void
}

function BrassDustParticles() {
      ...
      {particles.map((p) => (
        <div
          ...
          style={{
            ...
            opacity: p.opacity,
            animation: `v4DustFloat ${p.duration}s ease-in-out ${p.delay}s infinite`,
          }}
        />
      ))}
      <style>{`
        @keyframes v4DustFloat {
...
export function OrreryLanding({ onSelectPath }: OrreryLandingProps) {
  ...
  return (
    <div className="relative space-y-8">
      ...
      <div className="relative text-center space-y-3 pt-4">
        ...
        >
          Each planet represents an area of your life. Click the{" "}
          <span style={{ color: "#f97316", fontWeight: 600 }}>
            Dating & Daygame
          </span>{" "}
          planet to begin charting your goals. Other worlds will unlock as the
          system expands.
        </p>
      </div>
      ...
      <div className="relative">
        <OrreryVisualization
          ...
          daygameMoons={[
            { label: "Find the One", id: "one_person", color: "#ec4899" },
            { label: "Abundance", id: "abundance", color: "#f97316" },
          ]}
        />
      </div>

      {/* Path selection — appears when daygame clicked */}
      {showPathChoice && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            ...
            <button
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, rgba(236, 72, 153, 0.06) 0%, rgba(218, 165, 32, 0.03) 100%)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor =
                  "rgba(236, 72, 153, 0.5)"
                e.currentTarget.style.boxShadow =
                  "0 0 40px rgba(236, 72, 153, 0.12), inset 0 0 30px rgba(218, 165, 32, 0.03)"
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor =
            ...
            >
              ...
              <div
                ...
                style={{ borderColor: "rgba(205, 133, 63, 0.3)" }}
              />
              <div
            ...
            {/* Abundance */}
            <button
              data-testid="path-abundance"
              onClick={() => onSelectPath("abundance")}
              className="group relative overflow-hidden rounded-2xl p-6 text-left transition-all duration-300 cursor-pointer"
              style={{
                border: "1px solid rgba(249, 115, 22, 0.25)",
                background:
                  "linear-gradient(135deg, rgba(249, 115, 22, 0.06) 0%, rgba(218, 165, 32, 0.03) 100%)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor =
                  "rgba(249, 115, 22, 0.5)"
                e.currentTarget.style.boxShadow =
                  "0 0 40px rgba(249, 115, 22, 0.12), inset 0 0 30px rgba(218, 165, 32, 0.03)"
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor =
      ...
      <div className="relative">
        <div className="flex items-center gap-2 mb-4">
          <div
            ...
            style={{ backgroundColor: "rgba(205, 133, 63, 0.15)" }}
          />
          <span
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {visibleAreas.map((area) => {
            ...
            const Tag = isDaygame ? "button" : "div"

            return (
              <Tag
                key={area.id}
                data-testid={isDaygame ? "planet-grid-daygame" : undefined}
                className={`relative rounded-xl p-4 transition-all duration-200 text-left ${isDaygame ? "cursor-pointer" : ""}`}
                style={{
                  border: isDaygame
                ...
                {...(isDaygame ? { onClick: () => setShowPathChoice(true) } : {})}
              >
                <div
                  className="absolute top-0 right-0 w-4 h-4 border-t border-r rounded-tr-xl"
                  style={{ borderColor: "rgba(205, 133, 63, 0.2)" }}
                />
                ...
                <div className="flex items-center gap-3">
                  ...
                  {!isDaygame && (
                    <Lock
                      className="size-3 ml-auto flex-shrink-0"
