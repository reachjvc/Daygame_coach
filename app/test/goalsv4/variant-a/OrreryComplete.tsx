  ...
  const brightestStar = useMemo(() => {
    ...
    for (const [id, config] of curveConfigs) {
      ...
      if (milestones.length > maxSteps) {
        ...
        const tmpl = [...selectedL2s, ...selectedL3s].find(
          (t) => t.id === id
        )
    ...
    <div className="relative space-y-8">
        ...
        {bgParticles.map((s) => (
          <div
            ...
            style={{
              ...
              opacity: s.opacity,
              animation: `v4CompleteTwinkle ${2 + s.delay}s ease-in-out ${s.delay}s infinite`,
            }}
          />
        ))}
        <style>{`
          @keyframes v4CompleteTwinkle {
            0%, 100% { opacity: 0.03; }
            50% { opacity: 0.18; }
          }
        `}</style>
      ...
      <div className="relative text-center space-y-4 py-6">
        ...
        <div>
          ...
          >
            Your &quot;{constellationName}&quot; orrery is calibrated with{" "}
            {goals.length} celestial bodies to track your journey toward &quot;
            {selectedL1.title}&quot;.
          </p>
        </div>
      ...
      >
        <svg viewBox="0 0 100 50" className="w-full h-full">
          ...
          {selectedL2s.map((l2, i) => {
            const angle =
              (i / selectedL2s.length) * Math.PI * 2 - Math.PI / 2
          ...
          {selectedL3s.slice(0, 20).map((l3, i) => {
            const angle =
              (i / Math.min(selectedL3s.length, 20)) * Math.PI * 2 -
              Math.PI / 2
      ...
      <div className="relative space-y-4 max-w-xl mx-auto">
        ...
        >
          <div
            ...
            style={{ borderColor: `${brassColor}30` }}
          />
          <div
              ...
              {catGoals.map((g) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-3 rounded-lg p-3"
                    style={{
                      border: `1px solid ${brassColor}08`,
                      backgroundColor: `${brassColor}03`,
                    }}
                  >
                    <div
      ...
      <div
        ...
        style={{ borderTop: `1px solid ${brassColor}12` }}
      >
        <div
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium"
          style={{
            backgroundColor: `${goldColor}12`,
            color: goldColor,
        ...
        >
          In the real app, this would create all {goals.length} goals and take
          you to your personalized dashboard. For this prototype, you can chart
          a new system.
        </p>
