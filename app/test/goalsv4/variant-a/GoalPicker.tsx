...
export function GoalPicker({ path, onBack, onConfirm }: GoalPickerProps) {
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  style={{ backgroundColor: `${goldColor}12` }}
                >
      ...
      {selectedL1 && (
        <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <p
            ...
            style={{ color: "rgba(255,255,255,0.45)" }}
          >
            These celestial bodies orbit close to your star. Select the ones that
            matter to you.
          </p>
            ...
            {relevantL2s.map((l2) => {
              ...
              return (
                ...
                >
                  ...
                  <Trophy
                    className="size-4 ml-auto flex-shrink-0"
                    style={{ color: `${brassColor}30` }}
                  />
                </button>
              )
            })}
      ...
      {selectedL1 && selectedL2Ids.size > 0 && (
        <div className="space-y-3 animate-in fade-in slide-in-from-bottom-2 duration-300">
          ...
          <p
            ...
            style={{ color: "rgba(255,255,255,0.45)" }}
          >
            The furthest objects in your system. Toggle off anything outside your
            scope.
          </p>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{ backgroundColor: `${brassColor}05` }}
                  >
                    <button
          ...
          <div className="flex items-center justify-between max-w-3xl mx-auto">
            ...
            >
              ...
              <span
                ...
                style={{ color: `${brassColor}50` }}
              >
                (1 star + {selectedL2Ids.size} inner + {selectedL3Ids.size}{" "}
                outer)
              </span>
            </div>
            <Button
