          ...
          {l1Options.map((l1) => {
            ...
            return (
              <button
                ...
                style={{
                  border: isSelected ? `1px solid ${aurora.primary}50` : "1px solid rgba(255,255,255,0.05)",
              ...
              >
                ...
                <div className="rounded-lg p-2" style={{ background: `${aurora.primary}08` }}>
                  <div
                ...
                <span className="text-sm font-light" style={{ color: isSelected ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.55)" }}>
                  {l1.title}
                </span>
              </button>
            )
            ...
            {relevantL2s.map((l2) => {
              ...
              return (
                <button
                  ...
                  style={{
                    border: isSelected ? `1px solid ${aurora.primary}30` : "1px solid rgba(255,255,255,0.04)",
                    backgroundColor: isSelected ? `${aurora.primary}05` : "transparent",
                ...
                >
                  <div className="flex items-center gap-3 p-3" style={{ backgroundColor: "rgba(255,255,255,0.015)" }}>
                    ...
                    >
                      ...
                      <CatIcon className="size-4" style={{ color: "rgba(255,255,255,0.2)" }} />
                      <span className="text-sm font-light tracking-wide" style={{ color: "rgba(255,255,255,0.65)" }}>
                    ...
                    <button
                      ...
                      className="text-xs font-light transition-colors cursor-pointer px-2 py-0.5 rounded"
                  ...
                  {isExpanded && (
                    <div className="px-3 pb-3 pt-1 space-y-1">
                      {isDirtyDog && (
                        <p className="text-xs italic mb-2 pl-6 font-light" style={{ color: "rgba(255,255,255,0.2)" }}>
                        ...
                        return (
                          ...
                          >
                            <div
                              ...
                              style={{
                                borderColor: isSelected ? aurora.primary : "rgba(255,255,255,0.08)",
                                background: isSelected ? aurora.gradient : "transparent",
                              }}
                            >
                            ...
                            <span className="text-[10px] flex-shrink-0 font-light" style={{ color: "rgba(255,255,255,0.18)" }}>
