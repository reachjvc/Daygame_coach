...
export const MONEY_JARS: MoneyJar[] = [
  { name: "Necessities", pct: 55, blurb: "Rent, bills, phone, transport. If this runs over 55%, that's the paycheck-to-paycheck trap. Shrink the lifestyle first.", videoId: "rqbZyviDnfU" },
  { name: "Long-term savings", pct: 10, blurb: "Builds your emergency fund. 3-6 months of expenses. Untouchable except a true emergency. A car and a vacation are neither.", videoId: "VfhmzqDHM4w" },
  ...
  { name: "Fun & play", pct: 10, blurb: "Spent guilt-free. You earned it. Enjoy it. Guilt-free fun is part of the system.", videoId: "VfhmzqDHM4w" },
...
export const MONEY_WEEKLY_RITUAL = {
  title: "The weekly money ritual. Pick a fixed day, 15 to 20 minutes",
  videoId: "DA_qgda-3L4",
  steps: [
...
export const RELATIONSHIP_JOURNAL_SCRIPT = {
  ...
  steps: [
    ...
    { title: "Any score at 7 or below → act now", detail: "Ask each other: what can I do to bring that to a ten? Seven is the tripwire. Catch it this week, while it's still a seven. Kill the monster while it's little.", videoId: "7F6AJgL6yvw" },
