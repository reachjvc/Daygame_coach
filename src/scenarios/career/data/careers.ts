 ...
 * Career Data
 *
 * Career options organized by archetype, including job titles,
 * reveal lines, and suggested tease/pull responses.
 */

import type { Archetype } from "../../shared/archetypes";
import type { OutfitCategory } from "../../openers/data/outfits";
...
// ─────────────────────────────────────────────────────────────────────────────
// Career Options by Archetype
// ─────────────────────────────────────────────────────────────────────────────

export const CAREER_OPTIONS_BY_ARCHETYPE: Record<string, CareerOption[]> = {
  powerhouse: [
    {
...
// ─────────────────────────────────────────────────────────────────────────────
// Career Options by Communication Tone (fallback)
// ─────────────────────────────────────────────────────────────────────────────

export const CAREER_OPTIONS_BY_TONE: Record<Archetype["communicationStyle"]["tone"], CareerOption[]> = {
...
// ─────────────────────────────────────────────────────────────────────────────
// Default Career Options (final fallback)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Outfit Categories by Archetype
// ─────────────────────────────────────────────────────────────────────────────

export const OUTFIT_CATEGORIES_BY_ARCHETYPE: Record<string, OutfitCategory[]> = {
...
// ─────────────────────────────────────────────────────────────────────────────
// Helper: Get career options for an archetype
// ─────────────────────────────────────────────────────────────────────────────

export function getCareerOptions(archetype: Archetype): CareerOption[] {
  return (
