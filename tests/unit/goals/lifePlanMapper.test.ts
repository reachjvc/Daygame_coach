...
import { emptyNsPlan, addGoal, normalizeNsPlan, serializeNsPlan } from "@/src/goals/northStarService"
/* The fixture lives in tests/support so the integration round trip uses the
   SAME plan. Two copies drift, and the one that drifts proves less. */
